...
////  .apiInfo(apiInfo()).select().paths(postPaths()).build(); // } // // private
////  Predicate<String> postPaths() { // return or(regex("/api/posts.*"),
////  regex("/api/javainuse.*")); // } // // private ApiInfo apiInfo() { // return
////  new ApiInfoBuilder().title("JavaInUse API") //
